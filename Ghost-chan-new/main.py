...
for cog in os.listdir(r"C:\Users\betha\Documents\gv\Ghost-chan-main\cogs"):
    try:
        if cog == '__pycache__':
            continue
...
async def about(ctx):
    ...
    embed.add_field(name="**Links**",
                    value="[**Ghost-chan's Invite Link**](https://discord.com/oauth2/authorize?client_id=854820855087104060&scope=bot&permissions=8586788863)\n[**Vote for Ghost-chan**](https://thebanditmc.net)\n[**Ghost-chan's Website**](https://himaa.xyz/ghost-chan)",
                    inline=True)
    embed.set_thumbnail(url="https://i.imgur.com/3Lgs39V.png")
    embed.set_footer(
        text="Made with Discord.py :: " + discord.__version__ + " and Python :: " + platform.python_version() + " | " + str(

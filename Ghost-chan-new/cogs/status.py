...
class Status(commands.Cog):
    ...
    async def change_status(self):
        ...
        try:
            ...
            m2 = ('{:,}'.format(m))
            name = [f"=w=help | Exorcising {len([s for s in self.bot.guilds])} servers!", "and exorcising the ghosts!", "for your ghost pings..", "Violet-chan struggling with bugs!", "Aidan you there?", "Hima..?", "TheBanditMC.net", "Bingo Bango"]
